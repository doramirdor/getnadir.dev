...
// The "Live routing decisions" terminal card. Self-contained: owns its own
// reveal + rolling-pulse animation, gated on scroll into view. Shared by the
// current hero and the annotated-hero experiment so the live proof stays in
// one place.
export const RoutingDemoTerminal = () => {

...
const tiers = [
  ...
  },
  {
    ...
    features: ["Everything in Open Source", "Hosted proxy (zero setup)", "Aggressive semantic dedup", "Web dashboard & analytics", "BYOK or use our keys", "Up to 25% of savings (10% above $2K)", "Email support"],
    cta: "Join Waitlist",
    ctaLink: "#waitlist",
    external: false,
    highlighted: true,
